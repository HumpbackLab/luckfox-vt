 ...
 * - increasing VTS to 0x03DE based on measured ~72fps output
 * - center-cropping a 1280x720 ROI
 * - updating the repeated output-size registers to 1280x720
 */
static const struct regval mis5001_linear_10_1280x720_regs[] = {
//Sensor revision:Mis5001
//Input clock frequency:27M
//Image output size:1280x720
//Frame timing and frame rate:Linear 60Fps (empirically tuned)
//System clock frequency:148.5M
//Output interface and data rate:MIPI 2Lane RAW10 891Mbps
//HTS = 310e/310f =0xBB8
//VTS = 310c/310d =0x3DE
...
static const struct regval mis5001_linear_10_1104x624_regs[] = {
//Sensor revision:Mis5001
//Input clock frequency:27M
//Image output size:1104x624
//Frame timing and frame rate:Linear 90Fps
//System clock frequency:148.5M
//Output interface and data rate:MIPI 2Lane RAW10 normal readout
//HTS = 310e/310f =0xBB8
//VTS = 310c/310d =0x294
