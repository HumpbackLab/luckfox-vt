...
#define MIS5001_LINK_FREQ		540000000ULL  //1080Mbps  Mbps/2 = MHz
#define MIS5001_PIXEL_RATE		(MIS5001_LINK_FREQ * 2 * \
...
//System clock frequency:216M
//Output interface and data rate:MIPI 2Lane RAW10 1080Mbps
//HTS = 310e/310f =0xBB8
//VTS = 310c/310d =0x960
//Tline = 13.88889us
	{0x300a, 0x01},
 ...
 * mipi_datarate per lane 1080Mbps, 2lane
 *
 * Derived from the 2592x1944 mode by:
 * - keeping HTS at 0x0BB8
 * - setting VTS to 0x04B0 for 60fps with the experimental 216MHz clock
 * - center-cropping a 1920x1080 ROI
 * - updating the repeated output-size registers to 1920x1080
 */
static const struct regval mis5001_linear_10_1920x1080_regs[] = {
//Sensor revision:Mis5001
//Input clock frequency:27M
//Image output size:1920x1080
//Frame timing and frame rate:Linear 60Fps (experimental PLL)
//System clock frequency:216M
//Output interface and data rate:MIPI 2Lane RAW10 1080Mbps
//HTS = 310e/310f =0xBB8
//VTS = 310c/310d =0x4B0
//ROI x_start/x_end = 0x0150/0x08CF
//ROI y_start/y_end = 0x01B0/0x05E9
	{0x300a, 0x01},
	{0x3006, 0x02},
	{REG_DELAY, 0x2d},
	{0x3307, 0xa0},
...
//HTS = 310e/310f =0xBB8
//VTS = 310c/310d =0x320
//ROI x_start/x_end = 0x0290/0x078F
//ROI y_start/y_end = 0x0264/0x0535
	{0x300a, 0x01},
	{0x3006, 0x02},
	{REG_DELAY, 0x2d},
	{0x3307, 0xa0},
...
static const struct regval mis5001_linear_10_832x464_regs[] = {
//Sensor revision:Mis5001
//Input clock frequency:27M
//Image output size:832x464
//Frame timing and frame rate:Linear 120Fps
//System clock frequency:216M
//Output interface and data rate:MIPI 2Lane RAW10 1080Mbps
//HTS = 310e/310f =0xBB8
//VTS = 310c/310d =0x258
//ROI x_start/x_end = 0x0370/0x06AF
//ROI y_start/y_end = 0x02E4/0x04B5
	{0x300a, 0x01},
	{0x3006, 0x02},
	{REG_DELAY, 0x2d},
	{0x3307, 0xa0},
...
static const struct mis5001_mode supported_modes[] = {
	...
	},
	{
		...
		.vts_def = 0x4b0,
		.bus_fmt = MEDIA_BUS_FMT_SGRBG10_1X10,
		.reg_list = mis5001_linear_10_1920x1080_regs,
		.hdr_mode = NO_HDR,
		.vc[PAD0] = V4L2_MBUS_CSI2_CHANNEL_0,
	},
	{
		...
		.vts_def = 0x320,
		.bus_fmt = MEDIA_BUS_FMT_SGRBG10_1X10,
		.reg_list = mis5001_linear_10_1280x720_regs,
		.hdr_mode = NO_HDR,
		.vc[PAD0] = V4L2_MBUS_CSI2_CHANNEL_0,
	},
	{
		...
		.vts_def = 0x258,
		.bus_fmt = MEDIA_BUS_FMT_SGRBG10_1X10,
		.reg_list = mis5001_linear_10_832x464_regs,
		.hdr_mode = NO_HDR,
		.vc[PAD0] = V4L2_MBUS_CSI2_CHANNEL_0,
	}
};
	...
	if (fmt->which == V4L2_SUBDEV_FORMAT_TRY) {
		...
		*v4l2_subdev_get_try_format(sd, cfg, fmt->pad) = fmt->format;
		...
		__v4l2_ctrl_modify_range(mis5001->vblank, vblank_def,
					 ...
					 1, vblank_def);
		__v4l2_ctrl_s_ctrl(mis5001->vblank, vblank_def);
...
static int mis5001_initialize_controls(struct mis5001 *mis5001)
{
	...
	v4l2_ctrl_new_std(handler, NULL, V4L2_CID_PIXEL_RATE,
			  0, MIS5001_PIXEL_RATE, 1, MIS5001_PIXEL_RATE);
